...
export default async function GoalsPage() {
  ...
  return (
    <div className="space-y-8">
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {goals.map((goal, i) => (
              <div
                key={goal.title}
                className="group p-4 rounded-xl border border-gray-100 hover:border-primary-200 hover:shadow-sm transition-all duration-200 animate-slide-up"
      ...
      {/* Info card */}
      <div className="flex items-start gap-4 p-5 rounded-xl bg-gray-50/80 border border-gray-100 animate-fade-in" style={{ animationDelay: '300ms' }}>
